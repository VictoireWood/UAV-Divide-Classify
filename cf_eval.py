...
from datasets_M import initialize, TrainDataset, TestDataset
...
groups = [TrainDataset(args.train_set_path, dataset_name=args.dataset_name, group_num=n, N=args.N,
                       min_images_per_class=args.min_images_per_class
                       ) for n in range(args.N * args.N)]

test_dataset = TestDataset(args.test_set_path, N=args.N, image_size=args.test_resize)
